...
const Cardlayout = () => {
  ...
  const getWater = (water) => {
    if (water <1100) {
        return 'Your water requirement is low. You should drink at most 1L of water';
    }
    if (water >= 1100 && water <1200) {
        return 'Your water requirement is not that high. You should drink at least 1100 ml of water';
    }
    if (water >= 1200 && water <1300) {
        return 'Your water requirement is less. You should drink at leats 1200 ml of water';
    }
    if (water >= 1300 && water < 1400) {
      return 'Your water requirement is no high. You should drink at least 1300 ml of water';
    }
    if (water >=1400 && water < 1500) {
      return 'Your water requirement is moderate. You should drink at least 1400 ml of water';
    }
    if (water >= 1500 && water <1600) {
      return 'Your water requirement is little high. You should drink at least 1500 ml of water';
    }
    if (water >= 1600 && water <1700) {
        return 'Your water requirement is good enough. You should drink at least 1600 ml of water';
    }
    if (water >= 1700 && water <1800) {
        return 'Your water requirement is high. You should drink at least 1700 ml of water';
    }
    if (water >= 1800 && water <1900) {
        return 'Your water requirement is quite high. You should drink at least 1800 ml of water';
    }
    if (water >= 1900 && water <2000) {
        return 'Your water requirement is very high. You should drink at least 2L of water';
    }
    else{
        return 'Your water requirement is enourmous. You should drink at least 2.5L of water'
    }
  };
  ...
  right: '0',width: '50%',
      ...
      <div>
        {
          isNaN(water)?null:<div style={{color: 'white'}} ><br/>Your Required Water Intake = {water}</div> 
        }
